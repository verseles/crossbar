...
class _SettingsTabState extends State<SettingsTab> {
              ...
              _buildSection(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(_formatInterval(settings.defaultRefreshInterval, l10n)),
                    trailing: const Icon(Icons.chevron_right),
                    onTap: () {
                      _showIntervalPickerDialog(settings, l10n);
                    },
                  ),
                ],
              ),
  ...
  void _showIntervalPickerDialog(SettingsService settings, AppLocalizations l10n) {
    final options = [
