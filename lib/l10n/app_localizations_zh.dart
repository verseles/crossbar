...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get widgetConfiguration => '小部件配置';

  @override
  String get selectPluginsForWidget => '选择要显示的插件';

  @override
  String get selectOnePlugin => '选择一个插件';

  @override
  String get selectPlugins => '选择插件';

  @override
  String get noPluginsAvailable => '没有可用的插件。请先安装一些插件。';

  @override
  String get widgetUpdateNote => '小部件在后台每 15 分钟更新一次。打开应用获取即时更新。';
}
